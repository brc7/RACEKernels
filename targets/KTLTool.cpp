...
/* Command line tool to evaluate ground-truth K TiLde values. Usage: 
KTLTool <data.libsvm> <queries.libsvm> <kernel_id> <bandwidth> <dimensions>
...
int main(int argc, char **argv){
	...
	if (argc < 6){
		...
		std::clog<<"KTLTool <data> <queries> <kernel_id> <bandwidth> <dimensions> "<<std::endl;
